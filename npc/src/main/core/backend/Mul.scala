...
class Mul(xlen: Int) extends Module {
  ...
  mulModuleS0.io.in.isMul32 := true.B
  mulModuleS0.io.in.isMul64 := false.B
  mulModuleS0.io.in.aIsUnSigned := func(4) & func(1) & func(0) 
...
class MulModuleS0(len: Int = 64) extends Module {
  ...
  private val signB = bIsSigned & Mux(isMul32, b(31), b(31))
  ...
  private val signOfUnSignAMul64 = isMul64 & aIsUnSigned & a(31)
...
class MulModuleS2(len: Int) extends Module {
  ...
  private val result = Wire(UInt(len.W))
  result := Mux(isHi, resultTmp(31, 0), resLow(31, 0))
