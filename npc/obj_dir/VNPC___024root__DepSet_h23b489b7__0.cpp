...
VL_INLINE_OPT void VNPC___024root___nba_sequent__TOP__0(VNPC___024root* vlSelf) {
    ...
    CData/*4:0*/ __Vdlyvdim0__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1;
    __Vdlyvdim0__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1 = 0;
    IData/*31:0*/ __Vdlyvval__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1;
    __Vdlyvval__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1 = 0;
    IData/*31:0*/ __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v2;
    __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v2 = 0;
    SData/*11:0*/ __Vdlyvdim0__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3;
    __Vdlyvdim0__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3 = 0;
    IData/*31:0*/ __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3;
    __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3 = 0;
    // Body
    if (vlSelf->NPC__DOT__stop) {
        VNPC___024unit____Vdpiimwrap_set_npc_state_TOP____024unit(vlSelf->io_NPC);
    }
    __Vdly__NPC__DOT___ifu_inst = vlSelf->NPC__DOT___ifu_inst;
    if (vlSelf->io_MemtoReg) {
        VNPC___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->io_result, __Vfunc_pmem_read__1__Vfuncout);
        vlSelf->NPC__DOT__wbu__DOT___lsu_DataOut = __Vfunc_pmem_read__1__Vfuncout;
        vlSelf->NPC__DOT___wbu_io_vaild = 1U;
    } else {
        vlSelf->NPC__DOT__wbu__DOT___lsu_DataOut = 0U;
        vlSelf->NPC__DOT___wbu_io_vaild = 0U;
    }
    if (vlSelf->io_MemWr) {
    ...
    __Vdlyvval__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1 
        = ((0U == (IData)(vlSelf->io_rd)) ? 0U : ((IData)(vlSelf->io_RegWr)
                                                  ...
                                                  ((IData)(vlSelf->NPC__DOT___idu_io_CsrWr)
                                                    ...
                                                    : vlSelf->io_Ref)));
    __Vdlyvdim0__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1 
        = vlSelf->io_rd;
    __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v2 
        = vlSelf->NPC__DOT__wbu__DOT____Vcellinp__Csr_ext__W2_data;
    __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3 
        = ((IData)(vlSelf->NPC__DOT___idu_io_CsrWr)
            ? vlSelf->io_result : vlSelf->NPC__DOT__wbu__DOT___Csr_ext_R2_data);
    __Vdlyvdim0__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3 
        = (vlSelf->NPC__DOT___ifu_inst >> 0x14U);
    if ((1U & ((((IData)(vlSelf->NPC__DOT___wbu_io_vaild) 
                 & (IData)(vlSelf->io_MemtoReg)) | 
                ((~ (IData)(vlSelf->NPC__DOT___wbu_io_vaild)) 
                 & (~ (IData)(vlSelf->io_MemtoReg)))) 
               & (~ (IData)(vlSelf->NPC__DOT___idu_io_halt))))) {
        VNPC___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->io_NPC, __Vfunc_pmem_read__0__Vfuncout);
        __Vdly__NPC__DOT___ifu_inst = __Vfunc_pmem_read__0__Vfuncout;
    } else {
        __Vdly__NPC__DOT___ifu_inst = vlSelf->NPC__DOT___ifu_inst;
    }
    if (vlSelf->reset) {
        vlSelf->NPC__DOT__pc = 0x80000000U;
    } else if (vlSelf->io_reset) {
        vlSelf->NPC__DOT__pc = 0x80000000U;
    } else if (((IData)(vlSelf->NPC__DOT___wbu_io_vaild) 
                == (IData)(vlSelf->io_MemtoReg))) {
        vlSelf->NPC__DOT__pc = vlSelf->NPC__DOT___exu_io_dnpc;
    }
    vlSelf->io_mDataOut = vlSelf->NPC__DOT__wbu__DOT___lsu_DataOut;
    vlSelf->io_vaild = vlSelf->NPC__DOT___wbu_io_vaild;
    vlSelf->NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory[0U] = 0U;
    vlSelf->NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory[__Vdlyvdim0__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1] 
        = __Vdlyvval__NPC__DOT__wbu__DOT__Ref_ext__DOT__Memory__v1;
    vlSelf->NPC__DOT__stop = ((IData)(vlSelf->reset) 
                              | (0x100073U != vlSelf->NPC__DOT___ifu_inst));
    vlSelf->NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory[0x342U] = 0xbU;
    vlSelf->NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory[0x300U] = 0x1800U;
    vlSelf->NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory[0x341U] 
        = __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v2;
    vlSelf->NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory[__Vdlyvdim0__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3] 
        = __Vdlyvval__NPC__DOT__wbu__DOT__Csr_ext__DOT__Memory__v3;
